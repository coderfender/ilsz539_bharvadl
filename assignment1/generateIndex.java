...
public class generateIndex {
	...
	public void readDirectory() {
		try (Stream<Path> paths = Files.walk(Paths.get("/Users/bharvadl/Downloads/corpus"))) {
	...
	public  void createIndex(Analyzer analyzer, String type) {
		...
		try {
			String indexPath = "/Users/bharvadl/Downloads/index";
	...
	public void printResults() {
		try {
			...
			System.out.println("Number of documents in the corpus:" + reader.maxDoc());
			System.out.println("Number of documents containing the term \"NEW\" for \"TEXT\" field: "
			...
			System.out.println("Size of vocabulary for this field: " + vocabulary.size());
			System.out.println(
					"Number of documents which have at least one term for this field: " + vocabulary.getDocCount());
...
class MyDocument {
	...
	public String toString() {
		return "MyDocument [doco=" + docno + ", head=" + head + ", byline=" + byline + ", dateline=" + dateline
				+ ", text=" + text + "]";
	}
